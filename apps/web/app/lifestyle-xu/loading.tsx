export default function LifestyleXuLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-yellow-50 to-white dark:from-gray-900 dark:via-gray-850 dark:to-gray-950">
      {/* Hero Skeleton */}
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-500 via-orange-500 to-yellow-600 py-16">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mx-auto mb-4 h-16 w-16 animate-pulse rounded-full bg-white/20"></div>
