...
export const metadata: Metadata = {
  title: 'Chính sách bảo mật - Lifestyle Super App',
  description:
    'Chính sách bảo mật và bảo vệ dữ liệu cá nhân của Lifestyle Super App.',
  openGraph: {
    title: 'Chính sách bảo mật - Lifestyle Super App',
    type: 'website',
    url: '/privacy',
...
export default async function PrivacyPage(): Promise<JSX.Element> {
  const data = await fetchContent('privacy-policy', 'vi');
